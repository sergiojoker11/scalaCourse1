 ...
 */
 @RunWith(classOf[JUnitRunner])
   ...
   */
  test("one plus one is three?") (assert(1 + 1 !== 3))
   ...
   */
  test("details why one plus one is not three") (assert(1 + 1 !== 3))
  // Fix me, please!
  ...
  test("sum of the same number three times") {
